...
export class Socket extends Container {
    ...
    public static readonly DEFAULT_OPTIONS: ISocketOptions = {
    ...
    public connect(): Promise<void> {;
        return new Promise((resolve, reject) => {
            ...
            const connectOptions = Object.assign({}, Socket.DEFAULT_OPTIONS, this.engine.options.socket, { query: { token, cId } });
