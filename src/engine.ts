...
import { Socket, ISocketOptions } from './classes/engine.socket';
...
import { Http, IHttpOptions } from './classes/engine.http';
...
export class Engine extends Drawable {
    ...
    public static readonly PIXEL_RATIO = window.devicePixelRatio || 1;
